...
const PERSONALITY = {
    ...
    AEQP: {
        name: "系统优化师",
        describe: `AEQP型程序员是系统优化师（也可以是OI爷），专注于对系统性能进行抽象分析和优化，喜欢探索新的优化方法，追求在保证系统质量的同时提升系统性能。他们对系统的抽象思维和性能优化有深入的理解。（在实际的测试中，很多OIer、算法竞赛选手也是这个结果。）AEQP与AERP不同的点或许是他们在算法竞赛中更加注重正确率，更加谨慎，或许更加注重深入思考，攻克困难算法题`,
